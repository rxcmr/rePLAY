...
@class GameCommandSay; @class Lightmapper; @class PFDevice; @class WorldZone; @class GameCommandDebug; @class GameCommandPlayerDie; @class Player; @class EntityConfig; @class Entity; @class FlurryUtil; @class GameCommand; @class MetaBlock; @class CCSpeed; @class Item; @class BaseBlock; 
