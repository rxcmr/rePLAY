...
@class Player; @class FlurryUtil; @class GameCommandSay; @class MetaBlock; @class Item; @class HBForceCepheiPrefs; @class GameCommandDebug; @class CCSpeed; @class GameCommandPlayerDie; @class BaseBlock; @class PFDevice; @class EntityConfig; @class WorldZone; @class GameCommand; @class Lightmapper; @class Entity; 
...
static BOOL _logos_meta_method$_ungrouped$HBForceCepheiPrefs$forceCepheiPrefsWhichIReallyNeedToAccessAndIKnowWhatImDoingISwear(_LOGOS_SELF_TYPE_NORMAL Class _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) { return YES; }
